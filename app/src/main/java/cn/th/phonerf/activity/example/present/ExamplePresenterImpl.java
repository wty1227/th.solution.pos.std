package cn.th.phonerf.activity.example.present;
...
public class ExamplePresenterImpl extends HttpRequestImpl implements IExamplePresenter {
    String TAG = "";
    private IExampleView mView;
