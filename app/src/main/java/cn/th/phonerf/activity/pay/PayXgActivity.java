...
public class PayXgActivity extends BaseActivity implements IPayView, View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pay_xz);
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        ...
        try {
            if (keyCode == KeyEvent.KEYCODE_ENTER) {
                ...
                str += keyCodeToChar(keyCode, _isShift) ;//String.valueOf(keyCode - 7);
                lbInput.setText(str);
                _isShift = false;
                return true;
            }
//            System.err.println(keyCode);
    ...
    public void resRequestData(String tag, String msg, JSONObject response) {
        try {
            switch (tag) {
                case ApiConstants.ACTION_PAY_XG: {
